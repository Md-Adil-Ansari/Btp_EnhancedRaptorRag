...
class GeminiQAModel(BaseQAModel):
    def __init__(self, model="gemini-2.5-flash"):
        ...
        Args:
            model (str, optional): The Gemini model version to use for answering. Defaults to "gemini-2.5-flash".
        """
        ...
        if not api_key:
            raise ValueError("GEMINI_API_KEY environment variable must be set to use GeminiQAModel.")
